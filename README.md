...
Built as part of VNigeria's August 2026 Red Hat hackathon, demonstrating a practical RHEL system administration use case: automated, auditable, least-privilege user lifecycle management — the kind of operational tooling relevant to enterprise RHEL deployments.
